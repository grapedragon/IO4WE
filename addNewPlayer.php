...
<body background="img/backdrops/cbt.png">
	<center>
	<h1>Add a New Student to the Website</h1>
    ...
    <p>&nbsp&nbsp&nbspPhone: &nbsp&nbsp&nbsp <input type="text" name="phone" size="20" maxlength="50" /></p>
	...
	<h4><a href="admin.php">Back to Administrator Page</a></h4>
	</center>
	</form>
